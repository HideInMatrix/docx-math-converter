...
// Based on the original MIT-licensed solution by yaokailun/kailunyao.
// Thanks to the original author for the OMML-to-docx math conversion approach retained here.
